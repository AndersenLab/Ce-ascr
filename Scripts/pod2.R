...
### pod-2 fine mapping for a3a5 trait ###
...
save(df_a3a5_pod2, file="Processed_Data/pod2_a3a5_fine.RData")
...
df_mecr1_pod2 <-df_ratio_split_pod2 %>%
...
qtl_all_a3a5_pod <- rbind(df_a3_fine_pod2, df_a5_fine_pod2) %>%
  dplyr::distinct(CHROM, POS, TRAIT, VARIANT_LOG10p, GENE_NAME, VARIANT_IMPACT)

save(qtl_all_a3a5_pod, file="Processed_Data/pod2_a3a5_fine.RData")
